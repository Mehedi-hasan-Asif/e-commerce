...
class _HomeBannerSliderState extends State<HomeBannerSlider> {
    ...
    return GetBuilder<SliderListController>(builder: (sliderListController) {
      return Visibility(
        ...
        replacement: const SizedBox(
          height: 192,
          child: CenterCircullarprogressIndicator(),
        ),
        child: Column(
          children: [
            _buildCarousalSlider(sliderListController),
            const SizedBox(
              height: 8,
            ),
            _buildCarousallDots(sliderListController)
          ],
        ),
      );
    });
  ...
  Widget _buildCarousalSlider(SliderListController sliderListController) {
  ...
  Widget _buildCarousallDots(SliderListController sliderListController) {
